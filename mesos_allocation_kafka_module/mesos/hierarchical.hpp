...
protected:
  ...
  static constexpr double MIN_CPUS = 0.01;
  static const Bytes MIN_MEM;
...
const Bytes HierarchicalAllocatorProcess<RoleSorter, FrameworkSorter>::MIN_MEM = Megabytes(32);
